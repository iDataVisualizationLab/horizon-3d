...
function fireLogging(graphType) {
    ...
    var myUrl = httpURLBase + '?user=' + userId + '&numYears=3&&graphType=' + graphType + '&task=Task1&questionKey=' + questionAnswer.question.key + '&correct=' + correct + '&duration=' + dur + "&selected=" + a + maxStr;
    httpGetAsync(myUrl);
