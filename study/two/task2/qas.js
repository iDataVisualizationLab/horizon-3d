...
function fireLogging(graphType) {
    ...
    var myUrl = httpURLBase + '?user=' + userId + '&numYears=2&graphType=' + graphType + '&task=Task2&questionKey=' + questionAnswer.question.key + '&correct=' + correct + '&duration=' + dur + "&selected=" + a + maxStr;
    httpGetAsync(myUrl);
